...
class DatabaseMigrationV1213Test {
    @Test
    fun `migration 12 to 13 repairs stored spending view SQL`() {
        val context = ApplicationProvider.getApplicationContext<android.content.Context>()
        val dbName = "migration-v1213-${System.currentTimeMillis()}.db"
        ...
        createVersion12TransactionsSchema(db)
        createBrokenVersion12Views(db)
    ...
    private fun createVersion12TransactionsSchema(db: SupportSQLiteDatabase) {
        db.execSQL(
            """
    ...
    private fun createBrokenVersion12Views(db: SupportSQLiteDatabase) {
        db.execSQL(
            """
