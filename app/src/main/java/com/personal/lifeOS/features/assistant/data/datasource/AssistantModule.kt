...
import com.personal.lifeOS.features.assistant.data.repository.DefaultAssistantActionExecutor
...
abstract class AssistantModule {
    ...
    @Binds
    @Singleton
    abstract fun bindAssistantActionExecutor(impl: DefaultAssistantActionExecutor): AssistantActionExecutor
}
